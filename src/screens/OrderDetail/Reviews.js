...
function Reviews({productId,productName}) {
    ...
    return (
        <AlertNotificationRoot>
            ...
            }} variant={'outline'} colorScheme={'yellow'} borderRadius={'xl'} endIcon={<IconMUI name="feedback" size={20} />} size={'md'}>
            ...
            <Modal isOpen={modalVisible} onClose={() => { setModalVisible(false); setContent(''), setRate(5.0) }} initialFocusRef={initialRef} finalFocusRef={finalRef}>
                <Modal.Content>
                    ...
                    <Modal.Body>
                        <Text style={{color:'black',fontSize:23,textAlign:'center',fontWeight:'bold',marginBottom:10}}>{productName}</Text>
                        <Radio.Group style={{ marginLeft: 0 }} value={rate} onChange={handleChangeRate} name="Star" accessibilityLabel="Pick Star">
                            ...
                            <HStack style={{marginHorizontal:80}}>
                            ...
                            <TextArea size={'lg'} value={content} onChangeText={handleChangeContent} style={{ paddingTop: 10 }} h={40} placeholder="Nhập ý kiến nhận xét" w="100%" maxW="300" />
                        </Radio.Group>
                    </Modal.Body>
                    <Modal.Footer>
